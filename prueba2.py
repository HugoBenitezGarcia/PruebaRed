...
def buscar_partida():
    ...
    print("[BUSCANDO] Conectando con otros jugadores", end="", flush=True)
    ...
    try:
        while True:
            ...
            if ahora - ultimo_envio > 2 and not oponente_encontrado:
                ...
                puntos += 1
                if puntos > 20:  # Resetear línea cada 20 puntos
                    print("\n[BUSCANDO] Conectando con otros jugadores", end="", flush=True)
                    puntos = 0
                ultimo_envio = ahora
            ...
            try:
                ...
                if len(partes) == 3 and partes[0] == "DESCUBRIR":
                    ...
                    if not confirmacion_enviada:
                        ...
                        print(f"[CONECTANDO] Estableciendo conexión con {nombre_oponente}...")
                ...
                # Recibir confirmación
                    ...
                    print(f"[CONFIRMADO] Conexión establecida con {nombre_confirm}")
